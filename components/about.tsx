        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Founded in 2015, NeuroFlare is dedicated to democratizing access to technology and digital skills. We
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-black p-6 rounded-2xl border border-white/10 max-w-xs modern-card">
              ...
              <p className="text-gray-300 text-sm">
                "NeuroFlare's programs have transformed our school. Our students now have access to technology and
